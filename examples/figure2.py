...
axs[0][1].set_xlabel('x',fontsize=10,labelpad=-1)
...
ax = axs[0][0]
ax.minorticks_on()
ax.errorbar(x,u,s,fmt='.',capsize=0,label='observed',markersize=5,color=gray1,zorder=0)
ax.plot(x,t,'r-',label='true signal',zorder=0.5)
ax.plot(x,z,'b-',label='filtered',zorder=1)
ax.fill_between(x,z-2*y,z+2*y,color='b',alpha=0.3,edgecolor='none',zorder=1)
